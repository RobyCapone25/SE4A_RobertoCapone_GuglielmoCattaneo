...
\midrule
17/07/2026 & 1.0 & Roberto Capone; Guglielmo Cattaneo & Initial complete release aligned with the final implementation contained in the project repository.\\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{enumerate}
  ...
  \item the final implementation contained in the project repository;
