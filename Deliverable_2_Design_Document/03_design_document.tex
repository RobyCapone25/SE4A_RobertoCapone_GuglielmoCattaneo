...
The class, sequence, and execution-flow figures are synchronized with the repository-maintained Mermaid sources in \texttt{snippets/docs/uml/}. The TikZ versions below are used to keep this document self-contained and printable.
